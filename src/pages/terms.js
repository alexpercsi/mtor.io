    ...
    <Layout pageName="terms">
      ...
      <Container>
        ...
        <p>1.1  These Terms and Conditions
          ...
          related applications (the Site).</p>
          <p>The Site provides the following
          services: Community connecting (Services). You agree that by accessing
        ...
        <p>  1.2  The supplemental policies set out in Section
          ...
          the Site or use the Services without parental permission.  1.7
           Additional policies which also apply to your use of the Site include:
             <span className="txt-purple">●</span>a  Our Privacy Notice, which sets out the terms on which we process
          ...
          <p>If you know or suspect that anyone other than you
          knows your user information (such as an identification code or user
          name) and/or password you must promptly notify us at support@mtor.io.</p>
          ...
          <p>4.6  We are not
          responsible and accept no liability for any User Content including any
          ...
          <p>5.5  We shall (a) prepare the Site and Our
          Content with reasonable skill and care; and (b) use industry standard
          ...
          <p>6.1  The Site may contain links to
          websites or applications operated by third parties.We do not have any
          ...
          (1) monitor the Site for breaches of these Terms and Conditions; (2)
          ...
          the proper functioning of the Site and Services.   7.2  We do not
          guarantee that the Site will be secure or free from bugs or viruses. 
          ...
          your own virus protection software.   8.    Modifications to and
          availability of the Site      8.1  We reserve the right to change,
          ...
          notice at any time.     8.2  We cannot guarantee the Site and Services
          ...
          corrections, updates, or releases.  8.3  There may be information on
          ...
          misrepresentation.   <span className="txt-purple">●</span> If we fail to comply with these Terms and
          ...
          foreseeable at the time you started using the Site/Services.</p>
              
          <h2 className="txt-purple">10.    Term and Termination </h2>     10.1  These Terms and Conditions
          ...
          mobile application;  (c) In the event of any failure of the mobile
          ...
          whatsoever with respect to the mobile application;  (d) You represent
          ...
          parties;  (e) You must comply with applicable third party terms of
          ...
          service agreement when using the mobile application; and  (f) You
          ...
          obligations to others at any time. 12.5  We shall not be responsible
          or liable for any loss, damage, delay or failure to act caused by any
          cause beyond our reasonable control.    12.6  If any provision or part
          of a provision of these Terms and Conditions is unlawful, void or
          unenforceable, that provision or part of the provision is deemed
          severable from these Terms and Conditions and does not affect the
          validity and enforceability of any remaining provisions.   12.7  There
          ...
          or use of the Site or Services.      12.8  The following are trade
          marks of mtor.io. You are not permitted to use them without our
          approval, unless they are part of material our Site explicitly states
          you are permitted to use.      12.9  A person who is not a party to
          these Terms and Conditions shall have no right under the Contracts
          (Rights of Third Parties) Act 1999 to enforce any term of these Terms
          and Conditions.  12.10  In order to resolve a complaint regarding the
          Services or to receive further information regarding use of the
          Services, please contact us by email at support@mtor.io. * These terms
          of use were created using Termly’s Terms and Conditions Generator.
        </p>
      </Container>
    </Layout>
  );
